    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        <div className="bg-[#0A3622] text-white rounded-lg p-6">
          ...
          <a href="https://pay.hotmart.com/R102720481T?checkoutMode=10" target="_blank" rel="noopener noreferrer" className="block w-full rounded-full bg-[#26d366] py-3 text-lg font-bold text-white text-center shadow-[0_4px_12px_rgba(38,211,102,0.3)] transition duration-150 ease-in-out hover:bg-[#22b858] hover:shadow-lg">BUY NOW →</a>
        </div>
